window.addEventListener('load', function () {
    (function(){
      ...
      .then(data => {
          let addActionButton = `
                  <button id="btn_id_${odontologo.id}" type="button" onclick="window.location.href = 'post_odontologos.html'" class="btn btn-success btn_id">
                ...
                `;
          const iconAdd = document.querySelector('#div_odontologo_table');
          iconAdd.innerHTML = addActionButton;
      //recorremos la colección de peliculas del JSON
         for(odontologo of data){
            ...
            odontologoRow.innerHTML = '<td>' + updateButton + '</td>' +
                    ...
                    '<td>' + deleteButton + updateActionButton + '</td>';
